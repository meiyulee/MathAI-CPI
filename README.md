...
<p align="center">
  <b>🌐 <a href="https://sites.google.com/view/usinflation/" style="text-decoration: none; color: #0969da;">【 點此觀看：Live 互動式產品看板 (Google Sites) 】</a></b> 
  &nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;&nbsp;
  <b>🚀 <a href="https://mathai-cpi-dynamicplot.streamlit.app/" style="text-decoration: none; color: #0969da;">【 點此進入：Streamlit 雲端應用程式 】</a></b>
</p>
...
一位深耕於**數據規律邏輯與數據科學落地**的跨領域研究者。專長為總體經濟模型實證、時間序列機器學習演算法研發、以及量化金融因子工程。
